...
(function(e) {
  ...
  e.fn.ddslick = function(l) {
    if (c[l]) {
      ...
      } else { e.error("Method " + l + " does not exists.") }
    }
  };
  ...
  c.init = function(l) {
    ...
    return this.each(function() {
      ...
      if (!q) {
        ...
        if (l.keepJSONItemsOnTop) { e.merge(l.data, n) }
        else                      { l.data = e.merge(n, l.data) }
  ...
  c.select = function(l) {
    return this.each(function() {
      if (l.index !== undefined) { j(e(this), l.index) }
    })
  };
  ...
  function g(o) {
    ...
    if (m.length <= 0 && l.length > 0) { o.find(".dd-selected-text").css("lineHeight", n) }
  }
  ...
  function h(l) {
    l.find(".dd-option").each(function() {
      ...
      if (o.length <= 0 && m.length > 0) { p.find(".dd-option-text").css("lineHeight", n) }
    })
  }
